...
# mount points
/dev/block/mmcblk0p12                          /system           ext4    noatime,noauto_da_alloc,nodiratime,barrier=0,nobh,ro                                 wait
/dev/block/mmcblk0p2                           /cache            ext4    noatime,noauto_da_alloc,nosuid,nodev,nodiratime,barrier=0,nobh,errors=panic          wait
/dev/block/mmcblk0p9                           /data             ext4    noatime,noauto_da_alloc,nosuid,nodev,nodiratime,barrier=0,nobh,errors=panic          wait
